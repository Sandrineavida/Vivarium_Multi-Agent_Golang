...
var SpeciesAttributes = map[MyEspece]struct {
	...
	AraignéeSauteuse: {AgeRate: 3, MaxAge: 65, GrownUpAge: 5, TooOldToReproduceAge: 20, NbProgeniture: 2, NiveauEnergie: 36},
}
...
var InsectSpeeds = map[MyEspece]int{
	...
	Grillons:         3, // 蟋蟀速度中等
	Lombric:          2, // 蚯蚓速度较慢
	PetitSerpent:     4, // 小蛇速度较快
	AraignéeSauteuse: 5, // 跳蛛速度非常快
	// ...其他昆虫物种
}
